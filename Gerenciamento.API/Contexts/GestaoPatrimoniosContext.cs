...
public partial class GestaoPatrimoniosContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AreaID).HasName("PK__Area__70B820285F19130B");

            entity.HasIndex(e => e.NomeArea, "UQ__Area__9A77976046534029").IsUnique();
        ...
        {
            entity.HasKey(e => e.BairroID).HasName("PK__Bairro__4A093623823FBF7D");
        ...
        {
            entity.HasKey(e => e.CargoID).HasName("PK__Cargo__B4E665ED0CE3D1E4");

            entity.HasIndex(e => e.NomeCargo, "UQ__Cargo__4D9FD7DEB5ADED35").IsUnique();
        ...
        {
            entity.HasKey(e => e.CidadeID).HasName("PK__Cidade__B6800959EA45DA92");
        ...
        {
            entity.HasKey(e => e.EnderecoID).HasName("PK__Endereco__B9D9462FB525DECA");
        ...
        {
            entity.HasKey(e => e.LocalizacaoID).HasName("PK__Localiza__83ABDECA8E6DD53C");
        ...
        {
            entity.HasKey(e => e.LogPatrimonioID).HasName("PK__LogPatri__E716D12B4845C080");
        ...
        {
            entity.HasKey(e => e.PatrimonioID).HasName("PK__Patrimon__C5A60BDED753BB38");

            entity.ToTable(tb => tb.HasTrigger("trg_Patrimonio_SoftDelete"));

            entity.HasIndex(e => e.NumeroPatrimonio, "UQ__Patrimon__3BC8B35D8041F5A1").IsUnique();
        ...
        {
            entity.HasKey(e => e.TransferenciaID).HasName("PK__Solicita__E5B4F5F2CFCD92B8");
        ...
        {
            entity.HasKey(e => e.StatusPatrimonioID).HasName("PK__StatusPa__B3F3360970EADBF5");

            entity.HasIndex(e => e.NomeStatus, "UQ__StatusPa__C5C60F1A9EA186C5").IsUnique();
        ...
        {
            entity.HasKey(e => e.StatusTransferenciaID).HasName("PK__StatusTr__7AA828B9A8CC1305");

            entity.HasIndex(e => e.NomeStatus, "UQ__StatusTr__C5C60F1A3578FA8C").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoAlteracaoID).HasName("PK__TipoAlte__9BEF4F0D446469A7");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoAlte__7859A10AC535C666").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoUsuarioID).HasName("PK__TipoUsua__7F22C702ACCE0423");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoUsua__7859A10ACE79BE8A").IsUnique();
        ...
        {
            entity.HasKey(e => e.UsuarioID).HasName("PK__Usuario__2B3DE79881CB9655");

            entity.ToTable(tb => tb.HasTrigger("trg_Usuario_SoftDelete"));

            entity.HasIndex(e => e.RG, "UQ__Usuario__321537C82F63F887").IsUnique();

            entity.HasIndex(e => e.CarteiraTrabalho, "UQ__Usuario__6E25BCA2146D9948").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D10534EBC528E2").IsUnique();

            entity.HasIndex(e => e.CPF, "UQ__Usuario__C1F89731D2282E0E").IsUnique();

            entity.HasIndex(e => e.NIF, "UQ__Usuario__C7DEC330A08BB660").IsUnique();
